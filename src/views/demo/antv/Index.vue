<template>
  <div id="graphWrap" ref="graphWrap"></div>
</template>
...
export default defineComponent({
  setup() {
    ...
    onMounted(() => {
      ...
      graphInstance.on('add:topic', ({ node }: { node: Node }) => {
        const { id } = node
      ...
      graphInstance.bindKey(['backspace', 'delete'], () => {
        const selectedNodes = graphInstance
          .getSelectedCells()
